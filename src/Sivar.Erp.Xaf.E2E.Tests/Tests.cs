...
namespace Sivar.Erp.Xaf.Module.E2E.Tests;

public class XafTests : IDisposable {
    const string BlazorAppName = "Sivar.Erp.XafBlazor";
    const string WinAppName = "Sivar.Erp.XafWin";
    ...
    public XafTests() {
        FixtureContext.RegisterApplications(
            ...
            new WinApplicationOptions(WinAppName, string.Format(@"{0}\..\..\..\..\Sivar.Erp.Xaf.Win\bin\EasyTest\net8.0-windows\Sivar.Erp.Xaf.Win.exe", Environment.CurrentDirectory))
        );
