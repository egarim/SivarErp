...
namespace Sivar.Erp.Core.Application.Repositories.Inventory;
...
public interface IProductRepository : IRepository<Product>
{
    ...
    Task<IEnumerable<Product>> GetByTypeAsync(Domain.Enums.ProductType type, CancellationToken cancellationToken = default);
...
public interface IInventoryTransactionRepository : IRepository<InventoryTransaction>
{
    ...
    Task<IEnumerable<InventoryTransaction>> GetByTypeAsync(Domain.Enums.InventoryTransactionType type, CancellationToken cancellationToken = default);
    Task<string> GenerateTransactionNumberAsync(Domain.Enums.InventoryTransactionType type, CancellationToken cancellationToken = default);
}
