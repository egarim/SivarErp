...
public class SimpleSalesOrdersController : ControllerBase
{
    private readonly ISalesOrderService _salesOrderService;
    private readonly ILogger<SimpleSalesOrdersController> _logger;

    public SimpleSalesOrdersController(ISalesOrderService salesOrderService, ILogger<SimpleSalesOrdersController> logger)
    {
