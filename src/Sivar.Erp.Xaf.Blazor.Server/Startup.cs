...
using Sivar.Erp.EfCore;
using Sivar.Erp.EfCore.BusinessObjects;
using Sivar.Erp.Xaf.Blazor.Server.Services;

namespace Sivar.Erp.Xaf.Blazor.Server;
        ...
        services.AddXaf(Configuration, builder => {
            ...
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options => options.PreFetchReferenceProperties())
                    .WithDbContext<XafEFCoreDbContext>((serviceProvider, options) => {
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(Sivar.Erp.EfCore.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(Sivar.Erp.EfCore.BusinessObjects.ApplicationUserLoginInfo);
