...
namespace Sivar.Erp.Infrastructure.Sequencers
{
    public interface ISequencerService
    {
        ...
        Task<ISequenceDto> CreateSequenceAsync(ISequenceDto sequence);
        ...
        Task<ISequenceDto> UpdateSequenceAsync(ISequenceDto sequence);
        ...
        Task<ISequenceDto?> GetSequenceByCodeAsync(string code);

        /// <summary>
        /// Gets all active sequences
        /// </summary>
        /// <returns>List of active sequences</returns>
        Task<IEnumerable<ISequenceDto>> GetActiveSequencesAsync();
    }
}
