namespace Sivar.Erp.Services.Accounting.BalanceCalculators
{
    public interface IAccountBalanceCalculator
    {
        ...
        decimal CalculateAccountBalance(string AccountOfficialCode, DateOnly asOfDate);
        ...
        (decimal DebitTurnover, decimal CreditTurnover) CalculateAccountTurnover(string AccountOfficialCode, DateOnly startDate, DateOnly endDate);
        ...
        bool HasTransactions(string AccountOfficialCode);
    }
}