...
namespace Sivar.Erp.Modules.Documents.Application.DTOs
{
    ...
    {
        private IItem _item;
        private string _lineItem = string.Empty;
        private decimal _amount;
        private decimal _quantity = 1;
        private decimal _unitPrice;
        private ObservableCollection<ITotal> _lineTotals = new ObservableCollection<ITotal>();
        ...
        /// <summary>
        /// Collection of totals associated with this line (taxes, discounts, etc.)
        /// </summary>
