...
{
    /// <summary>
    /// DTO for cash flow line with calculated value
    /// </summary>
    public class CashFlowLineValueDto
    {
        /// <summary>
        ...
        /// <summary>
        /// Type of the cash flow line
        /// </summary>
        public CashFlowLineType LineType { get; set; }

        /// <summary>
        /// Whether this line represents net income
        /// </summary>
        ...
        {
            return IsHeader || IsNetIncome || LineText.ToUpper().Contains("TOTAL") ||
                   LineText.ToUpper().Contains("NET");
        }
